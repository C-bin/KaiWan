...
/*
 一，开玩介绍
 开玩是一款能赚钱的APP，用户主要通过完成任务来赚钱，每个任务会获得1-50元不等的现金奖励，获得的现金可以通过支付宝或微信直接提现，并且有签到赚钱，用户可以每天赚不停。
 二，关于赚钱
...
- (void)creatUI {
    ...
    label.text = @"   开玩是一款能赚钱的APP，用户主要通过完成任务来赚钱，每个任务会获得1-50元不等的现金奖励，获得的现金可以通过支付宝或微信直接提现，并且有签到赚钱，用户可以每天赚不停。";
